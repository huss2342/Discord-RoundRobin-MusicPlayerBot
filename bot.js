...
async function playNextSong(voiceChannel, textChannel) {
    ...
    try {
        const resource = createAudioResource(song.path, { inputType: StreamType.Arbitrary });
        ...
        //     });
        //     playNextSong(voiceChannel, textChannel); // Call with voiceChannel instead of interaction
        // });
